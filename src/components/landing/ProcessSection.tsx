              ...
              <div key={index} className="relative">
                <div className={`grid md:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap gap-3">
                        {step.features.map((feature, featureIndex) => (
                          <div
                            key={featureIndex}
                            className="glass-card px-4 py-2 rounded-full border border-primary/20 text-sm text-primary font-medium"
                          >
                            {feature}
                          </div>
                        ))}
                  ...
                  <div className={`relative ${index % 2 === 1 ? 'md:order-1' : ''}`}>
                    <div className="glass-card p-8 rounded-2xl border border-gray-800/50 shadow-2xl shadow-primary/10">
                      <div className="aspect-square bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-6 flex flex-col items-center justify-center space-y-4">
                        <div className="w-20 h-20 bg-gradient-to-br from-primary/30 to-green-400/30 rounded-2xl flex items-center justify-center">
                          <Icon className="w-10 h-10 text-primary" />
                        </div>
                        <div className="text-center space-y-2">
                          <div className="h-3 bg-primary/30 rounded w-24 animate-pulse" />
