...
const fragmentShader = `
  ...
  // ---- PALETA VERDE: mapeia a saída do CPPN para verdes ----
  vec3 emeraldPalette(float t) {
    // tons de verde: profundo -> médio -> brilhante
    vec3 deep  = vec3(0.02, 0.10, 0.06);   // #041A10
    vec3 mid   = vec3(0.07, 0.60, 0.33);   // ~#12A86A
